...
final class BlogColumnFormatterUtil {

    private static final Logger LOGGER = LoggerFactory.getLogger(BlogColumnFormatterUtil.class);

    private BlogColumnFormatterUtil() {
    }
